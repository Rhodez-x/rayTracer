...
public class Main
{
    ...
    public static void createAndAddObjects() throws FileNotFoundException, IOException
    {
        ...
        createObjObject("rayTracer/bunny.obj", -2.6, -0.2, -10, new Material(new Vector3D(Math.random(), Math.random(), Math.random())));
        createObjObject("rayTracer/suzanne.obj", 2.7, 0.35, -10, new Material(new Vector3D(Math.random(), Math.random(), Math.random())));
        createObjObject("rayTracer/wt_teapot.obj", 0.01, 0.01, -10, new Material(new Vector3D(Math.random(), Math.random(), Math.random())));

        createObjObject("rayTracer/suzanne.obj", -2.6, 2.4, -10, new Material(new Vector3D(Math.random(), Math.random(), Math.random())));
        createObjObject("rayTracer/dragon.obj", 2.6, 2.3, -10, new Material(new Vector3D(Math.random(), Math.random(), Math.random())));
        createObjObject("rayTracer/wt_teapot.obj", 0.01, 2.3, -10, new Material(new Vector3D(Math.random(), Math.random(), Math.random())));

        createObjObject("rayTracer/dragon.obj", -2.6, -2.7, -10, new Material(new Vector3D(Math.random(), Math.random(), Math.random())));
        createObjObject("rayTracer/wt_teapot.obj", 2.6, -2.7, -10, new Material(new Vector3D(Math.random(), Math.random(), Math.random())));
        createObjObject("rayTracer/bunny.obj", 0.01, -2.7, -10, new Material(new Vector3D(Math.random(), Math.random(), Math.random())));
