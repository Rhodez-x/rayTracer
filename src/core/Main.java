...
public class Main
{
    ...
    {
        Sphere mySphere_1 = new Sphere(new Vector3D(-1.0, 1, 2.5), 1.0, new Material(MaterialType.LAMBERTIAN, new Vector3D(0, 0.0, 0.3)));
        Sphere mySphere_4 = new Sphere(new Vector3D(0, 0, -1.0), 2.0, new Material(MaterialType.LAMBERTIAN, new Vector3D(0.5, 0, 0)));
